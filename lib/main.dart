...
const request = "https://api.hgbrasil.com/finance?format=json&key=8bf623c7";
...
// Requisição dos dados no servidor
Future<Map> getData() async {
  http.Response response = await http.get(request);
  return json.decode(response.body);
} // fim de requisição de dados no servidor
...
*/----------------------------------------------------------------------------
  void _yeneChanged(String text) {
    ...
    euroController.text = (yene * this.yene / dolar).toStringAsFixed(2);
              ...
              switch (snapshot.connectionState) {
                ...
                default:
                  if (snapshot.hasError) {
                    ...
                    yene = snapshot.data["results"]["currencies"]["JPY"]["buy"];
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          buildTextField( "Euros", "€", euroController, _euroChanged), Divider(),
                          buildTextField( "Yen", "¥", yeneController, _yeneChanged), Divider(),
                        ],
                      ),
                    );
                  }
